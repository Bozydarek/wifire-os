...
struct _PDCLIB_locale _PDCLIB_global_locale = {
	...
	/* E2BIG      */ (char *)"E2BIG: Too many arguments on the list",
	/* ECONNRESET */ (char *)"ECONNRESET: Connection reset by peer",
	/* EISCONN    */ (char *)"ISCONN: Already connected",
	/* ENOENT     */ (char *)"NOENT: No such file or directory",
	...
	/* EDEADLK    */ (char *)"EDEADLN: Deadlock condition",
	/* EISDIR     */ (char *)"EISDIR: Target is a directory",
	/* ENOEXEC    */ (char *)"ENOEXEC: Target is not executable",
	/* ENOTSOCK   */ (char *)"ENOTSOCK: Target is not a socket",
	/* ESPIPE     */ (char *)"ESPIPE: Invalid seek operation on pipe",
	/* EADDRINUSE */ (char *)"EADDRINUSE: Address already in use",
	/* EDESTADDRREQ */ (char *)"EDESTADDRREQ: Destionation address missing",
	/* ELOOP      */ (char *)"ELOOP: Symbollic links form a loop",
	/* ENOLCK     */ (char *)"ENLOCK: No record locks available",
	/* ENOTSUPP   */ (char *)"ENOTSUPP: Operation is not supported",
	/* ESRCH      */ (char *)"ESRCH: No such process",
	/* EADDRNOTAVAIL */ (char *)"EADDRNOTAVAIL: Cannot use requested address",
	/* EMFILE     */ (char *)"EMFILE: Too many files open",
	/* ENOLINK    */ (char *)"ENOLINK: Link has been damaged",
	/* ENOTTY     */ (char *)"ENOTTY: Target is not a TTY",
	/* ETIME      */ (char *)"ETIME: Time expired",
	/* EAFNOSUPPORT */ (char *)"EAFNOTSUPPORT: Address family not supported",
	/* EEXIST     */ (char *)"EEXISTS: File already exists",
	/* EMLINK     */ (char *)"EMLINK: Too many links",
	/* ENOMEM     */ (char *)"ENOMEM: Not enough memory",
	/* ENXIO      */ (char *)"ENXIO: No such device",
	/* ETIMEDOUT  */ (char *)"ETIMEDOUT: Connection timed out",
	/* EAGAIN     */ (char *)"EAGAIN/EWOULDBLOCK: Try again, the operation would block",
	/* EFAULT     */ (char *)"EFAULT: Invalid address",
	/* EMSGSIZE   */ (char *)"EMSGSIZE: Message too large",
	/* ENOMSG     */ (char *)"ENOMSG: No messages",
	/* EOPNOTSUPP */ (char *)"EOPNOTSUPP: Target does not support such operation",
	/* ETXTBSY    */ (char *)"ETXTBSY: Text file is busy",
	/* EALREADY   */ (char *)"EALREADY: Operation is already in progress",
	/* EFBIG      */ (char *)"EFBIG: File is too big",
	/* ENAMETOOLONG */ (char *)"ENAMETOOLONG: File name is too long",
	/* ENOPROTOOPT */ (char *)"ENOPROTOPOT: Protocol does not support such operation",
	/* EOVERFLOW  */ (char *)"EOVERFLOW: Value overflowed, too large for specified data type",
	/* EBADF      */ (char *)"EBADF: Bad file identifier",
	/* EHOSTUNREACH */ (char *)"EHOSTUNREACH: No route to host",
	/* ENETDOWN   */ (char *)"ENETDOWN: Network down",
	/* ENOSPC     */ (char *)"ENOSPC: No free space left on the device",
	/* EOWNERDEAD */ (char *)"EOWNERDEAD: Owner has died",
	/* EXDEV      */ (char *)"EXDEV: Link across devices",
	/* EBADMSG    */ (char *)"EBADMSG: Corrupted message or message has no data",
	/* EIDRM      */ (char *)"EIDRM: Identifier already removed",
	/* ENETRESET  */ (char *)"ENETRESET: Network reset",
	/* ENOSR      */ (char *)"ENOSR: Stream is out of resources",
	/* EPERM      */ (char *)"EPERM: Not an owner",
	/* EBUSY      */ (char *)"EBUSY: Device or resource busy",
	/* ENETUNREACH */ (char *)"ENETUNREACH: Network is unreachable",
	/* ENOSTR     */ (char *)"ENOSTR: Device is not a stream",
	/* EPIPE      */ (char *)"EPIPE: Broken pipe",
	/* ECANCELED  */ (char *)"ECANCELED: Operation cancelled",
	/* EINPROGRESS */ (char *)"EINPROGRESS: Operation is now in progress",
	/* ENFILE     */ (char *)"ENFILE: File table overflow",
	/* ENOSYS     */ (char *)"ENOSYS: Invalid system call number",
	/* EPROTO     */ (char *)"EPROTO: In-protocol error",
	/* ECHILD     */ (char *)"ECHILD: No child processes",
	/* EINTR      */ (char *)"EINTR: Interrupted system call",
	/* ENOBUFS    */ (char *)"ENOBUFS: No buffer space available",
	/* ENOTCONN   */ (char *)"ENOTCONN: Not connected",
	/* EPROTONOSUPPORT */ (char *)"EPROTONOSUPPORT: Protocol is not supported",
	/* ECONNABORTED */ (char *)"ECONNABORTED: Connection cancelled",
	/* EINVAL     */ (char *)"EINVAL: Invalid argument",
	/* ENODATA    */ (char *)"ENODATA: No data available",
	/* ENOTDIR    */ (char *)"ENOTDIR: Not a directory",
	/* EPROTOTYPE */ (char *)"EPROTOTYPE: Wrong protocol type",
    },
};
